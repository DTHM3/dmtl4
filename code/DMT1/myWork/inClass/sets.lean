...
Predicate for all strings

fun (s : String) → True

def allStrings : String → Prop :=
  fun s => TrueP

Empty set natural nums
def emptySetListNat :=
  Set(ListNat) :=
  fun ln => False
...
#reudce (types := true) tinyMembershipPred 1 1
/-
...
/-
Given r how would you define the domain of r
-/
...
-- Can just use Rel.dom r -> gives the domain
