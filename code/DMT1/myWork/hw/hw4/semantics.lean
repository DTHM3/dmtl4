import DMT1.myWork.hw.hw4.syntax
import DMT1.myWork.hw.hw4.domain

namespace DMT1.myWork.hw.hw4.semantics
open DMT1.myWork.hw.hw4.domain

/- @@@
@@@ -/
-- given syntactic operator terms, return corresponding Nat- and Bool-valued functions
open DMT1.myWork.hw.hw4.domain
open DMT1.myWork.hw.hw4.syntax
...
end  DMT1.myWork.hw.hw4.semantics
