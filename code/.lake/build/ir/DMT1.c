...
lean_object* initialize_DMT1_myWork_hw_hw3_axioms(uint8_t builtin, lean_object*);
lean_object* initialize_DMT1_myWork_hw_hw3_interpretation(uint8_t builtin, lean_object*);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_DMT1_myWork_hw_hw3_axioms(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_DMT1_myWork_hw_hw3_interpretation(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
